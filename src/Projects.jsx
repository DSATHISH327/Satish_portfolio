    ...
    <>
      ...
      <div className='projects' id='Projects'>
        <div className='project1'>
            ...
            <FontAwesomeIcon icon={faArrowDown} className='arrow-Down'/>
            <a href="https://photography-alpha-three.vercel.app/"  target="_blank" rel="noopener noreferrer" className='project-link'>Desaboina Satish Portfolio</a>
        </div>
        ...
        <div className='project3'>
            ...
            <FontAwesomeIcon icon={faArrowDown} className='arrow-Down'/>
            <a href="https://photography-alpha-three.vercel.app/"  target="_blank" rel="noopener noreferrer" className='project-link'>Laptops E-Comerce PLatform</a>
        </div>
      </div>
    </>
  )
